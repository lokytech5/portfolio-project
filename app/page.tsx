            ...
            <div className="hero-content flex-col md:flex-row-reverse lg:flex-row-reverse items-center">
              ...
              <div className="lg:w-1/2 text-center lg:text-left mt-10 lg:mt-0">
                ...
                <div className="flex justify-center lg:justify-start space-x-4">
                  <Link href="/contact">
                    <button className="btn btn-primary text-lg py-3 px-6 hover:scale-105 transition-transform">
                      Get in touch
                    </button>
                  </Link>
                  <Link href="/resume">
                    <button className="btn bg-white text-black border border-black text-lg py-3 px-6 hover:bg-gray-100 transition-transform">
                      Download CV
                    </button>
                  </Link>
                </div>
